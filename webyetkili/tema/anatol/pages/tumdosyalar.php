 <div class="page-heading">
            ...
            <ul class="breadcrumb">
                <li>
                 ...
                 <li>
                    <a href="#">Resim Galerisi</a>
                </li>
              <li class="active"> Galeri( Kategori İsmi)</li>
            </ul>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="btn-group pull-right">
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-check-square-o"></i> Tümünü Seç</button>
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-folder-open"></i> Kategori Ekleme</button>
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-trash-o"></i> Sil</button>
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> dosya yükleme</button>
                            </div>
                            ...
                            <div id="gallery" class="media-gal">
                                <div class="images item " >
                                    <a href="#myModal" data-toggle="modal">
                                        <img src="tema/anatol/images/gallery/image1.jpg" alt="" />
                                    </a>
                                    <p>img01.jpg </p>
                                </div>
                                ...
                                <div class=" audio item " >
                                    <a href="#myModal" data-toggle="modal">
                                        <img src="tema/anatol/images/gallery/image2.jpg" alt="" />
                                    </a>
                                    <p>img02.jpg </p>
                                </div>
                                ...
                                <div class=" video item " >
                                    <a href="#myModal" data-toggle="modal">
                                        <img src="tema/anatol/images/gallery/image3.jpg" alt="" />
                                    </a>
                                    <p>img03.jpg </p>
                                </div>
                                ...
                                <div class=" images audio item " >
                                    <a href="#myModal" data-toggle="modal">
                                        <img src="tema/anatol/images/gallery/image4.jpg" alt="" />
                                    </a>
                                    <p>img04.jpg </p>
                                </div>
                                ...
                                <div class=" images documents item " >
                                    <a href="#myModal" data-toggle="modal">
                                        <img src="tema/anatol/images/gallery/image5.jpg" alt="" />
                                    </a>
                                    <p>img05.jpg </p>
                                </div>
                                        ...
                                        <div class="modal-body row">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <div class="pull-right">
                                                    ...
                                                    <button class="btn btn-success btn-sm" type="button">Değişiklikleri Kaydet</button>
                                                </div>
                                            </div>
