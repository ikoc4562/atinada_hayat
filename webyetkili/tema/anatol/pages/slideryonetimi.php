 ...
 <div class="wrapper">
     ...
     <a href="index.php?pages=sliderekle" class="btn btn-primary btn-lg">Yeni Slider Ekle </a>
        <div class="adv-table">
        ...
        <td>  
            ...
            <td>asdpokaşsdkşa</td>
                ...
                <a href="index.php?pages=slidericerik" title="Göster" class="btn btn-default active"> <i class="fa fa-laptop"></i></a>
                 <a href="#" title="Ayarlar" class="btn btn-default active">   <i class="fa fa-gear"></i></a>
