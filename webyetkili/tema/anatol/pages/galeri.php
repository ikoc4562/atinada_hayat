 <div class="page-heading">
            ...
            <ul class="breadcrumb">
              ...
              <li class="active"> Galeri( Katogeri İsmi)</li>
            </ul>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="btn-group pull-right">
                                ...
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-folder-open"></i> Kategori Eklenecek </button>
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-trash-o"></i> Silbutton>
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i>Siteye Dosya Yuklenecek</button>
                            </div>
