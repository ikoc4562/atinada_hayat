...
$sql = $db->query("INSERT INTO sss (baslik,kat,yonlendir,target,icerik,include1,include2,include3,aktif,anasayfa,sira,baslik_eng,icerik_eng,yonlendir_eng,ilk,fotograf) VALUES ('".$baslik."','".$kat."','".$_POST['yonlendir']."','".$target."','".$icerik."','".$_POST['include1']."','".$_POST['include2']."','".$_POST['include3']."','".$aktif."','".$anasayfa."','".$sonsayi."','".$baslik_eng."','".$icerik_eng."','".$_POST['yonlendir_eng']."','".$ilk."','".$resim."')");
