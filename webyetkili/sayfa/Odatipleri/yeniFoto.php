...
if($anaresim == true){
	...
	if($_POST['tumoda']==true){
		...
		$sql = $db->query("INSERT INTO odagaleri (baslik,kat,anaresim,fotograf,aktif,sira) VALUES ('".$baslik."',99999,'".$anaresim."','".$resim."','".$aktif."','".$sonsayi."')");	}
	else{
...
<?php }?>
 ...
 <meta http-equiv="refresh" content="3;URL=index.php?page=Odatipleri&git=Fotograf&id=<?=$_GET['id']?>" />
</div>
