...
$kac = $db->prepare("SELECT * FROM ziyaretlergaleri");
$say = $kac->rowCount();
// son sıra sayic
$sonsayi = $say + "1";

if ($_POST['islem'] == "ziyaretlergaleriekle"){
...
$db->query("INSERT INTO ziyaretlergaleri (baslik,kat,baslik_eng,fotograf,aktif,sira) VALUES ('".$icerik."','".$kat."','".$_POST['baslik_eng']."','".$resim."','".$aktif."','".$sonsayi."')");
$mesaj = 'başarılı';
...
<?php }?>
 ...
 <meta http-equiv="refresh" content="3;URL=index.php?page=Ziyaretler&git=Fotograf&id=<?=$_POST['kat']?>" />
</div>
...
<div class="col-sm-12">
<input name="islem" type="hidden" id="islem" value="ziyaretlergaleriekle" />
