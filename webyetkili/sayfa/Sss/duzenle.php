...
if ($_FILES["fotograf"]["name"] != ""){
			...
			$kaynak = "../images/sss/".$_GET['resimadi'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf2"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi2'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf2 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim2,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf3"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi3'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf3 = :foto WHERE id = :id");
...
if ($_FILES["fotograf4"]["name"] != ""){
			...
			$kaynak = "../images/sss/".$_GET['resimadi4'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf4 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim4,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf5"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi5'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf5 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim5,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf6"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi6'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf6 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim6,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf7"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi7'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf7 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim7,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf8"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi8'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf8 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim8,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf9"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi9'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf9 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim9,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf10"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi10'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf10 = :foto WHERE id = :id");
			$sql->execute(['foto'=>$resim10,'id'=>$_GET['id']]);
}

if ($_FILES["fotograf11"]["name"] != ""){

			$kaynak = "../images/sss/".$_GET['resimadi11'];
			@unlink($kaynak);
			$hedef	= "../images/sss";
			...
			$sql = $db->prepare("UPDATE sss SET fotograf11 = :foto WHERE id = :id");
