...
$kac = $db->query("SELECT * FROM sss");
$say = $kac->rowCount();
// son sıra sayic
$sonsayi = $say + "1";

if ($_POST['islem'] == "sssekle"){
...
$db->query("INSERT INTO sss (baslik,kat,yonlendir,target,icerik,include1,include2,include3,aktif,anasayfa,sira,baslik_eng,icerik_eng,yonlendir_eng,ilk,fotograf,fotograf2,fotograf3,fotograf4,fotograf5,fotograf6,fotograf7,fotograf8,fotograf9,fotograf10,gosterim) VALUES ('".$baslik."','".$kat."','".$_POST['yonlendir']."','".$target."','".$icerik."','".$_POST['include1']."','".$_POST['include2']."','".$_POST['include3']."','".$aktif."','".$anasayfa."','".$sonsayi."','".$baslik_eng."','".$icerik_eng."','".$_POST['yonlendir_eng']."',0,'".$resim."','','','','','','','','','',0)");
...
<div class="col-sm-12">
<input name="islem" type="hidden" id="islem" value="sssekle" />
