...
$kac = $db->query("SELECT * FROM urundosya");
$say = $kac->rowCount();
// son sıra sayic
$sonsayi = $say + "1";

if ($_POST['islem'] == "urundosyaekle"){
...
$sql = $db->query("INSERT INTO urundosya (baslik,kat,baslik_eng,fotograf,aktif,sira) VALUES ('".$baslik."','".$kat."','".$baslik_eng."','".$resim."','".$aktif."','".$sonsayi."')");
$mesaj = 'başarılı';
...
<?php }?>
 ...
 <meta http-equiv="refresh" content="3;URL=index.php?page=Urun&git=Dosya&id=<?=$_POST['kat']?>" />
</div>
...
<div class="col-sm-12">
<input name="islem" type="hidden" id="islem" value="urundosyaekle" />
